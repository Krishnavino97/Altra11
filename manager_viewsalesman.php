<?php 
	...
	include "salesperson_pdf.php";

	$sql = "SELECT ID, username, address, email, mobile FROM salesperson";
...
<div class = "box">
		...
		<form align = "right" method = "POST" action = "salesperson_pdf.php">
